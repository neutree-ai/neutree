...
class SGLangPDCollocatedAppStaticTest(unittest.TestCase):
    def test_pd_app_declares_sglang_disaggregation_contract(self) -> None:
        ...
        self.assertIn("PDIngress", source)
    ...
    def test_sglang_engine_image_contains_pd_ingress_router(self) -> None:
        dockerfile = DOCKERFILE.read_text()

        self.assertIn("COPY serve/_ingress_router ./serve/_ingress_router", dockerfile)
