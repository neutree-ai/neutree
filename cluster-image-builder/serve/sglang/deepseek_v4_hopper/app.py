...
ray_orchestrator.go can drive it via `serve.sglang.deepseek_v4_hopper.app:app_builder`.

This is the DeepSeek-V4 Hopper-specific build of SGLang. The launch flow and
serving handler set are identical to the v0.5.10 mainline; the variant is
distinguished by its upstream image tag (`lmsysorg/sglang:deepseek-v4-hopper`),
which contains pre-compiled kernels tuned for DeepSeek-V4 on H100/H200.
