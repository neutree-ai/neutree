...
# v0.25.0 modules are organized into endpoint-specific sub-packages.
...
class Backend:
    def __init__(self,
        ...
        self.enable_per_request_metrics = engine_kwargs.pop("enable_per_request_metrics", False)
    ...
    async def _ensure_render(self):
        if self.online_renderer is None:
            self._ensure_model_config()
