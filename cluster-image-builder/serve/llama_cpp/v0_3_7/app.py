...
def app_builder(args: Dict[str, Any]) -> Application:
    ...
    backend_deployment = Backend.options(
        max_ongoing_requests=backend_options.get('max_concurrent_requests', 100),
    ...
    controller_deployment = Controller.options(
        max_ongoing_requests=backend_options.get('max_concurrent_requests', 100) * backend_options.get('num_replicas', 1),
