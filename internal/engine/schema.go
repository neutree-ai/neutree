...
//go:embed vllm/v0.22.1/schema.json
var vllmV0_22_1EngineSchema []byte
...
// GetVLLMV0_22_1EngineSchema returns the parsed JSON schema for vLLM V0.22.1 engine
func GetVLLMV0_22_1EngineSchema() (map[string]interface{}, error) {
	var schema map[string]interface{}
	if err := json.Unmarshal(vllmV0_22_1EngineSchema, &schema); err != nil {
		return nil, fmt.Errorf("failed to parse vLLM V0.22.1 engine schema: %w", err)
	}
...
var EngineSchemas = map[string]func() (map[string]interface{}, error){
	...
	"vllm-v0.22.1":     GetVLLMV0_22_1EngineSchema,
