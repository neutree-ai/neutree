...
//go:embed vllm/v0.18.0/schema.json
var vllmV0_18_0EngineSchema []byte
...
// GetVLLMV0_18_0EngineSchema returns the parsed JSON schema for vLLM V0.18.0 engine
func GetVLLMV0_18_0EngineSchema() (map[string]interface{}, error) {
	var schema map[string]interface{}
	if err := json.Unmarshal(vllmV0_18_0EngineSchema, &schema); err != nil {
		return nil, fmt.Errorf("failed to parse vLLM V0.18.0 engine schema: %w", err)
	}
...
var EngineSchemas = map[string]func() (map[string]interface{}, error){
	...
	"vllm-v0.18.0":     GetVLLMV0_18_0EngineSchema,
}
