...
//go:embed vllm/v0.19.0/templates/kubernetes/default.yaml
var vllmV0_19_0DeployTemplate string
...
//go:embed vllm/deepseekv4/templates/kubernetes/default.yaml
var vllmDeepseekV4DeployTemplate string
...
// GetVLLMV0_19_0DeployTemplate returns the default deployment template for vLLM V0.19.0 engine
func GetVLLMV0_19_0DeployTemplate() string {
	return base64.StdEncoding.EncodeToString([]byte(vllmV0_19_0DeployTemplate))
}

// GetVLLMV0_19_1DeployTemplate returns the default deployment template for vLLM V0.19.1 engine
func GetVLLMV0_19_1DeployTemplate() string {
...
// GetVLLMDeepseekV4DeployTemplate returns the default deployment template for vLLM deepseekv4 engine
func GetVLLMDeepseekV4DeployTemplate() string {
	return base64.StdEncoding.EncodeToString([]byte(vllmDeepseekV4DeployTemplate))
}
...
var DeployTemplates = map[string]func() string{
	...
	"vllm-deepseekv4":  GetVLLMDeepseekV4DeployTemplate,
