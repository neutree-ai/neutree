...
//go:embed vllm/v0.22.1/templates/kubernetes/default.yaml
var vllmV0_22_1DeployTemplate string
...
// GetVLLMV0_22_1DeployTemplate returns the default deployment template for vLLM V0.22.1 engine
func GetVLLMV0_22_1DeployTemplate() string {
	return base64.StdEncoding.EncodeToString([]byte(vllmV0_22_1DeployTemplate))
}
...
var DeployTemplates = map[string]func() string{
	...
	"vllm-v0.22.1":     GetVLLMV0_22_1DeployTemplate,
