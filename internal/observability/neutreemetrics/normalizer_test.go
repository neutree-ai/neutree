...
`,
	...
	assert.Contains(t, output, `neutree_gpu_pcie_tx_bytes_total{cluster_type="ray",gpu_index="0",gpu_uuid="GPU-abc",model="A100",neutree_cluster="static-a",node="head-0",node_ip="10.0.0.10",node_role="head",source="accelerator-exporter",static_node_cluster="static-a",workspace="default"} 1024`)
	assert.Contains(t, output, `neutree_gpu_pcie_rx_bytes_total{cluster_type="ray",gpu_index="0",gpu_uuid="GPU-abc",model="A100",neutree_cluster="static-a",node="head-0",node_ip="10.0.0.10",node_role="head",source="accelerator-exporter",static_node_cluster="static-a",workspace="default"} 2048`)
