...
// NewNodeAgentAdapter creates the Community NVIDIA NodeAgent adapter.
func NewNodeAgentAdapter() adapter.Accelerator {
...
func (a *nvidiaAccelerator) BuildKubernetesMetrics(
	...
	endpointReplicaGPUUsages := nvidiaHAMiEndpointReplicaUsagesFromEvidence(evidence)
