...
DCGM_FI_DEV_GPU_NAME{gpu="0",UUID="GPU-abc",DCGM_FI_DEV_GPU_NAME="Tesla T4"} 1
DCGM_FI_DEV_NVML_INDEX{UUID="GPU-abc"} 3
DCGM_FI_DEV_GPU_MINOR_NUMBER{UUID="GPU-abc"} 7
...
DCGM_FI_DEV_PCI_BUS_ID{UUID="GPU-abc",DCGM_FI_DEV_PCI_BUS_ID="00000000:00:0A.0"} 1
