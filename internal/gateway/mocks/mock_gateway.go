...
// DeleteExternalEndpoint provides a mock function with given fields: ee
func (_m *MockGateway) DeleteExternalEndpoint(ee *v1beta1.ExternalEndpoint) error {
	ret := _m.Called(ee)
...
// MockGateway_DeleteExternalEndpoint_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteExternalEndpoint'
type MockGateway_DeleteExternalEndpoint_Call struct {
	*mock.Call
}

// DeleteExternalEndpoint is a helper method to define mock.On call
//   - ee *v1beta1.ExternalEndpoint
func (_e *MockGateway_Expecter) DeleteExternalEndpoint(ee interface{}) *MockGateway_DeleteExternalEndpoint_Call {
	return &MockGateway_DeleteExternalEndpoint_Call{Call: _e.mock.On("DeleteExternalEndpoint", ee)}
}

func (_c *MockGateway_DeleteExternalEndpoint_Call) Run(run func(ee *v1beta1.ExternalEndpoint)) *MockGateway_DeleteExternalEndpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGateway_DeleteExternalEndpoint_Call) Return(_a0 error) *MockGateway_DeleteExternalEndpoint_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockGateway_DeleteExternalEndpoint_Call) RunAndReturn(run func(*v1beta1.ExternalEndpoint) error) *MockGateway_DeleteExternalEndpoint_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetExternalEndpointServeUrl provides a mock function with given fields: ee
func (_m *MockGateway) GetExternalEndpointServeUrl(ee *v1beta1.ExternalEndpoint) (string, error) {
	ret := _m.Called(ee)

	if len(ret) == 0 {
		panic("no return value specified for GetExternalEndpointServeUrl")
	}

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(*v1beta1.ExternalEndpoint) (string, error)); ok {
		return rf(ee)
	}
	if rf, ok := ret.Get(0).(func(*v1beta1.ExternalEndpoint) string); ok {
		r0 = rf(ee)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(*v1beta1.ExternalEndpoint) error); ok {
		r1 = rf(ee)
	} else {
		r1 = ret.Error(1)
	}
...
// MockGateway_GetExternalEndpointServeUrl_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetExternalEndpointServeUrl'
type MockGateway_GetExternalEndpointServeUrl_Call struct {
	*mock.Call
}

// GetExternalEndpointServeUrl is a helper method to define mock.On call
//   - ee *v1beta1.ExternalEndpoint
func (_e *MockGateway_Expecter) GetExternalEndpointServeUrl(ee interface{}) *MockGateway_GetExternalEndpointServeUrl_Call {
	return &MockGateway_GetExternalEndpointServeUrl_Call{Call: _e.mock.On("GetExternalEndpointServeUrl", ee)}
}

func (_c *MockGateway_GetExternalEndpointServeUrl_Call) Run(run func(ee *v1beta1.ExternalEndpoint)) *MockGateway_GetExternalEndpointServeUrl_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*v1beta1.ExternalEndpoint))
	})
	return _c
...
func (_c *MockGateway_GetExternalEndpointServeUrl_Call) Return(_a0 string, _a1 error) *MockGateway_GetExternalEndpointServeUrl_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockGateway_GetExternalEndpointServeUrl_Call) RunAndReturn(run func(*v1beta1.ExternalEndpoint) (string, error)) *MockGateway_GetExternalEndpointServeUrl_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockGateway) SyncExternalEndpoint(ee *v1beta1.ExternalEndpoint) error {
	ret := _m.Called(ee)
...
type MockGateway_SyncExternalEndpoint_Call struct {
	*mock.Call
}

// SyncExternalEndpoint is a helper method to define mock.On call
//   - ee *v1beta1.ExternalEndpoint
func (_e *MockGateway_Expecter) SyncExternalEndpoint(ee interface{}) *MockGateway_SyncExternalEndpoint_Call {
	return &MockGateway_SyncExternalEndpoint_Call{Call: _e.mock.On("SyncExternalEndpoint", ee)}
}

func (_c *MockGateway_SyncExternalEndpoint_Call) Run(run func(ee *v1beta1.ExternalEndpoint)) *MockGateway_SyncExternalEndpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*v1beta1.ExternalEndpoint))
	})
	return _c
...
func (_c *MockGateway_SyncExternalEndpoint_Call) RunAndReturn(run func(*v1beta1.ExternalEndpoint) error) *MockGateway_SyncExternalEndpoint_Call {
	_c.Call.Return(run)
	return _c
}
