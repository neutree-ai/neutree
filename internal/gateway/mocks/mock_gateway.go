...
func (_m *MockGateway) DeleteExternalEndpoint(ee *v1.ExternalEndpoint) error {
	ret := _m.Called(ee)
...
func (_c *MockGateway_DeleteExternalEndpoint_Call) Run(run func(ee *v1.ExternalEndpoint)) *MockGateway_DeleteExternalEndpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGateway_DeleteExternalEndpoint_Call) RunAndReturn(run func(*v1.ExternalEndpoint) error) *MockGateway_DeleteExternalEndpoint_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockGateway) GetExternalEndpointServeUrl(ee *v1.ExternalEndpoint) (string, error) {
	ret := _m.Called(ee)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(*v1.ExternalEndpoint) (string, error)); ok {
		return rf(ee)
	}
	if rf, ok := ret.Get(0).(func(*v1.ExternalEndpoint) string); ok {
		r0 = rf(ee)
	} else {
		r0 = ret.Get(0).(string)
	}
...
func (_c *MockGateway_GetExternalEndpointServeUrl_Call) Run(run func(ee *v1.ExternalEndpoint)) *MockGateway_GetExternalEndpointServeUrl_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*v1.ExternalEndpoint))
	})
	return _c
...
func (_c *MockGateway_GetExternalEndpointServeUrl_Call) RunAndReturn(run func(*v1.ExternalEndpoint) (string, error)) *MockGateway_GetExternalEndpointServeUrl_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockGateway_SyncExternalEndpoint_Call) Run(run func(ee *v1.ExternalEndpoint)) *MockGateway_SyncExternalEndpoint_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*v1.ExternalEndpoint))
	})
	return _c
