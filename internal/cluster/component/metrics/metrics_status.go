...
type MetricsStatus struct {
	...
	NeutreeNodeAgentMetricsRequired       bool
	NeutreeNodeAgentMetricsDaemonSetReady bool
	...
	NeutreeNodeAgentMetricsPodsReady      int
	NeutreeNodeAgentMetricsTotalPods      int
