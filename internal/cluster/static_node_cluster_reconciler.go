...
func (r *StaticNodeClusterReconciler) Plan(
	...
	status = advanceStaticNodeClusterUpgradeStatus(cluster, currentNodes, status)
	status = requireDesiredComponentsObserved(cluster, status, plans, staticNodeByName(currentNodes))
