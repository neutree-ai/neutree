...
type PluginRegistry interface {
	...
	GetAllConverters() map[string]v1.ResourceConverter

	// GetAllParsers returns all registered resource parsers
	GetAllParsers() map[string]v1.ResourceParser

	// GetConverter retrieves a resource converter by accelerator type
	GetConverter(acceleratorType string) (v1.ResourceConverter, bool)

	// GetParser retrieves a resource parser by accelerator type
	GetParser(acceleratorType string) (v1.ResourceParser, bool)
}
...
func (a *manager) GetAllConverters() map[string]v1.ResourceConverter {
	result := make(map[string]v1.ResourceConverter)
...
func (a *manager) GetAllParsers() map[string]v1.ResourceParser {
	result := make(map[string]v1.ResourceParser)
...
func (a *manager) GetConverter(acceleratorType string) (v1.ResourceConverter, bool) {
...
func (a *manager) GetParser(acceleratorType string) (v1.ResourceParser, bool) {
	p, ok := a.GetPlugin(acceleratorType)
	if !ok {
		return nil, false
	}
