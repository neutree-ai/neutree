...
type ClusterProfileComponents struct {
	...
	KubernetesRuntime ImageRef `json:"kubernetes_runtime,omitempty"`
...
// IsSupportedClusterType reports whether a ClusterProfile can be associated
// with the supplied cluster family.
func IsSupportedClusterType(clusterType string) bool {
	switch clusterType {
	case SSHClusterType, KubernetesClusterType:
		return true
	default:
		return false
	}
