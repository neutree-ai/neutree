...
// WithArgs preserves the legacy embedding API. New binary entrypoints should
// register flags with AddFlags from main instead.
...
// WithBuildInfo supplies build metadata used by the version command.
