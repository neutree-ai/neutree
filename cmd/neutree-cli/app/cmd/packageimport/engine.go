...
`,
	...
	cmd.Flags().StringVar(&opts.extractPath, "extract-path", "", "Parent directory for package extraction; a unique subdirectory is created automatically (default: system temp directory)")
