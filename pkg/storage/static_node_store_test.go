...
func TestStaticNodeObjectStoreUpsertStaticNodeRejectsDeletingClusterConflict(t *testing.T) {
	deletingNode := testStorageStaticNode(11, "default", "172.20.172.120", "static-a")
	deletingNode.Metadata.DeletionTimestamp = "2026-06-30T00:00:00Z"
	objectStorage := &fakeStaticNodeObjectStorage{
		nodes: []v1.StaticNode{deletingNode},
	}
	store := NewStaticNodeObjectStore(objectStorage)
